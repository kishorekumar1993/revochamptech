...
class _TutorialPageState extends State<TutorialPage>
  ...
  void _updateActiveHeading() {
    ...
    for (int i = 0; i < _headingKeys.length; i++) {
      ...
      if (context != null) {
        ...
        if (box != null) {
          ...
          // If the heading is above the top of the screen, it's not active
    ...
    if (activeIndex != _currentSectionIndex) {
      setState(() {
              ...
              children: [
                ...
                Container(
                  ...
                  child: LinearProgressIndicator(
                    ...
                    valueColor: const AlwaysStoppedAnimation(Color(0xFF2A5298)),
                  ),
                ),
              ],
            ),
  ...
  List<Widget> _buildContentItems() {
    ...
    for (int i = 0; i < _data!.content.length; i++) {
      ...
      // Insert ad after every N items, but skip if previous was heading
      if (i > 0 &&
          i % adFrequency == 0 &&
