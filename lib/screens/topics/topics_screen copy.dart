...
//       imageUrl: "https://revochamp.site/tech/og-images/$categoryName.png",
//       keywords: [
//         categoryName, 
//         "tutorial", 
//         "learn $categoryName", 
...
//     // Always set canonical to main category page
//     MetaService.setCanonical('https://revochamp.site/tech/$categoryName');
    
//     // Set verification tags if needed
...
//     // Always set canonical to main category to prevent duplicate content
...
//         isArticle: false,
//         noIndex: true, // CRITICAL: Prevent search result pages from being indexed
//       );
...
//         slug: "tech/${widget.category}",
//         isArticle: false,
//         noIndex: true, // Prevent filtered views from being indexed
//       );
//     } else {
//       _updateSEOMetaTags();
//     }
...
//   void _addPaginationMeta(int currentPage, int totalPages) {
//     if (!kIsWeb) return;
    
//     // Remove existing pagination links
//     html.document.querySelectorAll('link[rel="next"], link[rel="prev"]').forEach((e) => e.remove());
    
//     final baseUrl = 'https://revochamp.site/tech/${widget.category}';
...
//       description: 'Revochamp - Technology tutorials and insights for modern developers',
//     );
...
//       description: "Complete collection of ${widget.category} tutorials with practical examples and hands-on projects",
...
//     // Use config FAQs if available, otherwise use defaults
//     // final faqs =  _getDefaultFaqs();
//     // _config?.faqs?.map((faq) => {
//     //   'question': faq.question,
//     //   'answer': faq.answer,
//     // }).toList() ?? _getDefaultFaqs();
    
//     // MetaService.setFaqSchema(faqs);
//   }
...
//         "answer": "${widget.category} is a powerful technology used for modern application development. It provides developers with tools and frameworks to build efficient, scalable applications."
//       },
//       {
//         "question": "How long does it take to learn ${widget.category}?",
//         "answer": "The basics of ${widget.category} can be learned in 2-4 weeks with consistent practice. Mastery typically takes 3-6 months of regular coding and project building."
//       },
//       {
//         "question": "Is ${widget.category} good for beginners?",
//         "answer": "Yes! ${widget.category} has excellent documentation, a supportive community, and many beginner-friendly resources. Start with fundamentals and gradually work your way up."
//       },
//       {
//         "question": "What can I build with ${widget.category}?",
//         "answer": "You can build web applications, mobile apps, desktop software, backend services, and more. ${widget.category} is versatile and used across many industries."
//       },
//       {
//         "question": "Are these tutorials free?",
//         "answer": "Yes! All tutorials on Revochamp are completely free. We believe in making quality education accessible to everyone."
//       },
//     ];
//   }
