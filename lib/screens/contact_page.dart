...
void initState() {
  ...
  MetaService.updateMetaTags(
    title: "Contact RevoLearn | Support, Help & Enquiries",
    description:
        "Contact RevoLearn for support, queries, and feedback. Get help with courses, technical issues, and learning guidance.",
    slug: "contact",
  );
...
MetaService.setStructuredData({
  ...
  "@type": "ContactPage",
  "name": "Contact RevoLearn",
  "url": "https://revochamp.site/tech/contact",
  "description": "Official contact page for RevoLearn support and help",
  "inLanguage": "en",
