...
class _CoursePageState extends State<CoursePage> with TickerProviderStateMixin {
  ...
  void _updateMetaTags() {
    MetaService.updateMetaTags(
      ...
      description:
          "Browse all free programming courses on RevoLearn including Flutter, React, Web Development, Backend, DevOps, and AI.",
      slug: "courses",
    );
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            _buildStatItem("${(_totalStudents / 1000).toStringAsFixed(0)}K+", "Students"),
            Container(width: 1, height: 30, color: PremiumTheme.lightGray),
            _buildStatItem("$_totalTopics+", "Topics"),
          ],
        ),
      ),
    );
...
// // ==================== COURSE PAGE - WITH NAVIGATION IMPROVEMENTS ====================
// import 'dart:async';
// import 'package:flutter/material.dart';
// import 'package:go_router/go_router.dart';
// import 'package:techtutorial/core/meta_service.dart';
...
//       _selectedCategory = widget.initialCategory!;
//     }
//     _cachedCourses = _filteredCourses;
//     // Handle initial search query from navigation
...
//       "mainEntity": {
//         "@type": "ItemList",
//         "numberOfItems": _cachedCourses.length,
//       },
...
//     final filteredCourses = _cachedCourses;
//     return Scaffold(
//       backgroundColor: Colors.white,
...
//                     constraints: const BoxConstraints(maxWidth: 600),
//                     child: Text(
//                       "${_cachedCourses.length}+ courses available. All completely free. Find exactly what you need to advance your career.",
//                       style: TextStyle(
//                         fontSize: isMobile ? 14 : 16,
//                         color: PremiumTheme.textMuted,
//                         height: 1.5,
...
//                 mainAxisAlignment: MainAxisAlignment.spaceAround,
//                 children: [
//                   _buildStatItem("${allCourses.length}+", "Courses"),
//                   Container(
//                     width: 1,
//                     height: 30,
...
//                   ),
//                   _buildStatItem(
//                     "${allCourses.map((c) => c.studentCount).reduce((a, b) => a + b) ~/ 1000}K+",
//                     "Students",
//                   ),
//                   Container(
//                     width: 1,
...
//                   ),
//                   _buildStatItem(
//                     "${allCourses.map((c) => c.topics.length).reduce((a, b) => a + b)}+",
//                     "Topics",
//                   ),
//                 ],
//               ),
...
//                     _buildEmptyState()
//                   else
//                     _buildCourseGrid(filteredCourses, isMobile),
//                 ],
//               ),
//             ),
//           ),
...
//                   ElevatedButton(
//                     onPressed: () {
//                       showSnackBar("🎓 Skill assessment coming soon!", context);
//                     },
//                     style: ElevatedButton.styleFrom(
//                       backgroundColor: Colors.white,
//                       foregroundColor: PremiumTheme.richBlue,
...
//     //     'emoji': '🎨',
//     //     'color': 0xff1e40af,
//     //     'count': allCourses.where((c) => c.category == 'Frontend').length,
//     //   },
//     //   {
//     //     'name': 'Backend',
//     //     'emoji': '⚙️',
//     //     'color': 0xff047857,
//     //     'count': allCourses.where((c) => c.category == 'Backend').length,
//     //   },
//     //   {
//     //     'name': 'DevOps',
//     //     'emoji': '☁️',
//     //     'color': 0xff6b21a8,
//     //     'count': allCourses.where((c) => c.category == 'DevOps').length,
//     //   },
//     //   {
//     //     'name': 'AI & ML',
//     //     'emoji': '🤖',
//     //     'color': 0xff9f1239,
//     //     'count': allCourses.where((c) => c.category == 'AI & ML').length,
//     //   },
//     //   {
//     //     'name': 'Mobile',
//     //     'emoji': '📱',
//     //     'color': 0xff0369a1,
//     //     'count': allCourses.where((c) => c.category == 'Mobile').length,
//     //   },
//     // ];
//     final categories = [
//   {
...
//     'emoji': '🧩',
//     'color': 0xff0f766e,
//     'count': allCourses.where((c) => c.category == 'Full Stack').length,
//   },
...
//     'emoji': '📊',
//     'color': 0xff7c2d12,
//     'count': allCourses.where((c) => c.category == 'Data Science').length,
//   },
...
//     'emoji': '🌩️',
//     'color': 0xff1d4ed8,
//     'count': allCourses.where((c) => c.category == 'Cloud').length,
//   },
...
//     'emoji': '💻',
//     'color': 0xff374151,
//     'count': allCourses.where((c) => c.category == 'Programming').length,
//   },
...
//     'emoji': '🗄️',
//     'color': 0xff065f46,
//     'count': allCourses.where((c) => c.category == 'Database').length,
//   },
...
//     'emoji': '🧪',
//     'color': 0xffb45309,
//     'count': allCourses.where((c) => c.category == 'Testing').length,
//   },
...
//     'emoji': '🔐',
//     'color': 0xff991b1b,
//     'count': allCourses.where((c) => c.category == 'Cyber Security').length,
//   },
...
//     'emoji': '🖌️',
//     'color': 0xffbe185d,
//     'count': allCourses.where((c) => c.category == 'UI/UX').length,
//   },
...
//     'emoji': '🏗️',
//     'color': 0xff4338ca,
//     'count': allCourses.where((c) => c.category == 'System Design').length,
//   },
...
//     'emoji': '🛠️',
//     'color': 0xff475569,
//     'count': allCourses.where((c) => c.category == 'Tools').length,
//   },
...
//     'emoji': '🎯',
//     'color': 0xff0ea5e9,
//     'count': allCourses.where((c) => c.category == 'Interview Prep').length,
//   },
// ];
...
//     final beginnerCount = allCourses.where((c) => c.level == 'Beginner').length;
//     final intermediateCount = allCourses
//         .where((c) => c.level == 'Intermediate')
//         .length;
//     final advancedCount = allCourses.where((c) => c.level == 'Advanced').length;
//     final allCount = allCourses.length;
...
//             () => _onLevelChanged("Beginner"),
//           ),
//           const SizedBox(width: 12),
//           _buildLevelChip(
//             "Intermediate ($intermediateCount)",
//             _selectedLevel == "Intermediate",
//             () => _onLevelChanged("Intermediate"),
//           ),
//           const SizedBox(width: 12),
//           _buildLevelChip(
//             "Advanced ($advancedCount)",
//             _selectedLevel == "Advanced",
//             () => _onLevelChanged("Advanced"),
//           ),
//         ],
//       ),
//     );
...
//         side: BorderSide(
//           color: isSelected
//               ? PremiumTheme.richBlue.withValues(alpha: 0.3)
...
//             onTap: () => _showCourseDetail(courses[i]),
//             onStartLearning: () =>
//                 showSnackBar("🎓 Starting ${courses[i].title}", context),
//           ),
//         );
//       },
//     );
